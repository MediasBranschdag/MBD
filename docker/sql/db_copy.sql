...
('academicwork', 'Academic Work', 'Mer information kommer snart', 'academicwork.svg', 'academicwork.se'),
...
('bontouch', 'Bountouch', NULL, 'bontouch.png', 'bontouch.com'),
...
('comviq', 'Comviq', NULL, 'comviq.png', 'comviq.se'),
('conversionista', 'Conversionista', NULL, 'conversionista.svg', 'conversionista.com'),
...
('linkedin', 'LinkedIn', NULL, 'linkedin.png', 'linkedin.com'),
...
CREATE TABLE IF NOT EXISTS `company_involvement` (
  ...
  `seekingTitle` varchar(64) NOT NULL,
...
INSERT INTO `company_involvement` (`companyID`, `year`, `isSponsor`, `isExhibitor`, `isMainSponsor`, `seekingTitle`, `seekingDescription`, `mapPositionX`, `mapPositionY`) VALUES
('academicwork', 2020, 0, 1, 0, '', '', 50, 50),
('acando', 2019, 0, 1, 0, '', '', 50, 50),
('bontouch', 2019, 1, 0, 0, '', '', 50, 50),
('bontouch', 2020, 1, 0, 0, '', '', 50, 50),
('challengermode', 2019, 0, 1, 0, '', '', 50, 50),
('comviq', 2019, 1, 0, 0, '', '', 50, 50),
('conversionista', 2020, 0, 1, 0, '', '', 50, 50),
('datatjej', 2019, 0, 1, 0, '', '', 50, 50),
('decerno', 2019, 0, 1, 0, '', '', 50, 50),
('digpro', 2020, 0, 1, 0, '', '', 50, 50),
('dynabyte', 2020, 0, 1, 0, '', '', 50, 50),
('epidemicsound', 2019, 0, 1, 0, '', '', 50, 50),
('ericsson', 2019, 0, 1, 0, '', '', 50, 50),
('fatshark', 2019, 0, 1, 0, '', '', 50, 50),
('filter', 2019, 1, 0, 0, '', '', 50, 50),
('findout', 2020, 0, 1, 0, '', '', 50, 50),
('fishbrain', 2019, 0, 1, 0, '', '', 50, 50),
('forvalter', 2020, 0, 1, 0, 'Design and UX', '', 50, 50),
('frönb', 2020, 0, 1, 0, '', 'We’re in need of someone to make beautiful visualisations, video editing and other creative contents for our upcoming Kickstarter! If the person would like, and is a good fit, we would hire the person on to our team later on.', 50, 50),
('if', 2020, 0, 1, 0, '', '', 50, 50),
('isotop', 2020, 0, 1, 0, '', '', 50, 50),
('kry', 2019, 1, 0, 0, '', '', 50, 50),
('lexplore', 2019, 0, 1, 0, '', '', 50, 50),
('lindvalls', 2020, 1, 0, 0, '', '', 50, 50),
('linkedin', 2020, 0, 1, 0, '', '', 50, 50),
('mrg', 2019, 0, 1, 0, '', '', 50, 50),
('naia', 2020, 1, 0, 0, '', '', 50, 50),
('netlight', 2019, 1, 0, 0, '', '', 50, 50),
('nightli', 2020, 0, 1, 0, 'Summer internship', 'We are looking for anyone who believes in using digital solutions to improve and extend a real life experience. Therefore we are looking for someone wanting improve our product from a user experience perspective. What is the future way of using an app before, during and after a party or night out?', 50, 50),
('nordicmorninggroup', 2020, 0, 1, 0, '', '', 50, 50),
('plackers', 2019, 1, 0, 0, '', '', 50, 50),
('prime', 2019, 0, 1, 0, '', '', 50, 50),
('redbee', 2020, 0, 1, 0, '', '', 50, 50),
('schibsted', 2020, 0, 1, 1, '', '', 50, 50),
('sproud', 2019, 1, 0, 0, '', '', 50, 50),
('sproud', 2020, 1, 0, 0, '', '', 50, 50),
('sr', 2019, 0, 1, 0, '', '', 50, 50),
('startuplifers', 2020, 0, 1, 0, '', '', 50, 50),
('studentkortet', 2019, 1, 0, 0, '', '', 50, 50),
('sverigesingenjorer', 2019, 0, 1, 0, '', '', 50, 50),
('sverigesingenjorer', 2020, 0, 1, 0, '', '', 50, 50),
('svt', 2020, 0, 1, 0, '', '', 50, 50),
('teamengine', 2020, 0, 1, 0, '', '', 50, 50),
('tekompaniet', 2020, 1, 0, 0, '', '', 50, 50),
('toptracer', 2020, 0, 1, 0, '', '', 50, 50),
('unionen', 2020, 0, 1, 0, '', '', 50, 50),
('westmediasystem', 2020, 0, 1, 0, '', '', 50, 50),
('wesupero', 2020, 1, 0, 0, '', '', 50, 50),
('xlent', 2020, 0, 1, 0, '', '', 50, 50);
...
INSERT INTO `events19` (`ID`, `type`, `title`, `description`, `date`, `time`, `location`, `fb_link`, `image`, `show`) VALUES
