...
export class Company {
    ...
    public getDescription(): { se: string; en: string } {
        return {
            se:
                this.description_se === null || this.description_se === ''
                    ? this.description_en
                    : this.description_se,
            en:
                this.description_en === null || this.description_en === ''
                    ? this.description_se
                    : this.description_en,
        }
    }
...
export type companyAction =
    | 'current-year-involvement'
    | 'last-year-involvement'
