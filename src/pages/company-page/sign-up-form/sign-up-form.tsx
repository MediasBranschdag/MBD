...
const SignUpForm: FC = () => {
    ...
    const opportunities: string[] = [
        TranslationModel.translate(
            phrases.sign_up.opportunities.full_time
        ) as string,
        TranslationModel.translate(
            phrases.sign_up.opportunities.part_time
        ) as string,
        TranslationModel.translate(
            phrases.sign_up.opportunities.summer_jobs
        ) as string,
        TranslationModel.translate(
            phrases.sign_up.opportunities.master_thesis
        ) as string,
        TranslationModel.translate(
            phrases.sign_up.opportunities.internships
        ) as string,
        TranslationModel.translate(
            phrases.sign_up.opportunities.trainee_program
        ) as string,
        TranslationModel.translate(
            phrases.sign_up.opportunities.events
        ) as string,
    ]
    ...
    const textInputs = [
        ...
        },
        {
            name: 'companyId',
            placeholder: TranslationModel.translate(
                phrases.sign_up.organization_number
            ),
        ...
        },
        {
            name: 'contactPerson',
            placeholder: TranslationModel.translate(
                phrases.sign_up.contact_person
            ),
        ...
        },
        {
            name: 'invoiceAddress',
            placeholder: TranslationModel.translate(
                phrases.sign_up.invoice_address
            ),
            ...
            if (input.obligatory && input.inputState === '') {
                ...
                setErrorMessage(
                    TranslationModel.translate({
                        se:
                            'Du måste ange ' +
                            (input.placeholder as string).toLowerCase() +
                            '.',
...
*/
        ...
        formData.append(
            'subject',
            `${
                TranslationModel.translate(phrases.interest_form) as string
            } - ${companyName}`
        )
        ...
        <div>
            ...
            >
                ...
                <span onClick={() => setHoldEvents(true)}>
                    <input
                        type={'radio'}
                        checked={holdEvents ?? false}
                        onChange={() => {}}
                    />
                    <label className='no-select'>
                        {TranslationModel.translate(phrases.sign_up.yes)}
                    </label>
                </span>
                <span onClick={() => setHoldEvents(false)}>
                    <input
                        type={'radio'}
                        checked={holdEvents === null ? false : !holdEvents}
                        onChange={() => {}}
                    />
                    <label className='no-select'>
                        {TranslationModel.translate(phrases.sign_up.no)}
                    </label>
                </span>
                <br />
                <br />
                    ...
                    {opportunities.map((opportunity) => (
                        <span
                            ...
                            onClick={() =>
                                setOppSelect({
                                    ...oppSelect,
                                    [opportunity]: !oppSelect[opportunity],
                                })
                            }
                        >
                            <input
                                type={'checkbox'}
                                checked={oppSelect[opportunity]}
                                onChange={() => {}}
                            />
            ...
            {doneMessage ? (
                <p className='sign-up-message'>{doneMessage}</p>
            ) : (
                <></>
            )}
            {disableSend ? (
